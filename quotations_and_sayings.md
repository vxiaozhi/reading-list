...
- 感慨一下，年初的时候agent还是空中楼阁，而随着从代码agent的深入应用开始，其他应用方向的agent不再是空谈，大家也发现了主要限制当前阶段agent的其实不是LLM本身的性能，而是整个工程调度闭环框架的设计，基于一个好的闭环设计，去构造数据进行训练，不仅有利于上各种RL算法，还能将所有可能的场景框在这个框架范围内，也让LLM更容易收敛到这个使用场景。
- AI没有替代我的思考，AI替代的是我思考之外的一切苦力.
